export const CONFIG = {
  ...
  // 📸 GANTI LINK FOTO KEDUA (YANG ADA BINGKAI POLAROID) DI SINI (BISA PAKAI LINK GOOGLE DRIVE)
  FOTO_GAME: "https://drive.google.com/file/d/1rCiHYYB8IOLFOaRHz7sm5IueuuBatc1l/view?usp=sharing"
};
